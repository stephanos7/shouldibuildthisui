...
export type FrontendDeveloperCount = (typeof decisionFactOptions.frontendDeveloperCount)[number];
...
export type DesignSystemMaturity = (typeof decisionFactOptions.designSystemMaturity)[number];

export type UiKnowledgeDistribution = (typeof decisionFactOptions.uiKnowledgeDistribution)[number];

export type DesignEngineeringFriction = (typeof decisionFactOptions.designEngineeringFriction)[number];

export type StandardizationIntent = (typeof decisionFactOptions.standardizationIntent)[number];

export type DataGridComplexity = (typeof decisionFactOptions.dataGridComplexity)[number];

export type PerformanceCriticality = (typeof decisionFactOptions.performanceCriticality)[number];

export type AccessibilityCriticality =
  (typeof decisionFactOptions.accessibilityCriticality)[number];

export type ChangeLeadTime = (typeof decisionFactOptions.changeLeadTime)[number];

export type UiRegressionFrequency = (typeof decisionFactOptions.uiRegressionFrequency)[number];

export type DeliveryUrgency = (typeof decisionFactOptions.deliveryUrgency)[number];

export type ApplicationCriticality = (typeof decisionFactOptions.applicationCriticality)[number];

export type SupportExpectation = (typeof decisionFactOptions.supportExpectation)[number];

export type OwnershipHorizon = (typeof decisionFactOptions.ownershipHorizon)[number];
