...
export const qualityRiskInteractionRules = [
  {
    ...
    intent:
      "Capture low-risk contexts where direct implementation remains appropriate.",
    reason:
  ...
  },
  {
    ...
    intent:
      "Favor safer delivery choices when teams are under deadline pressure and already unstable.",
    reason:
      "Regression-prone UI work under a fixed deadline increases the value of proven prebuilt components.",
    enabled: true,
    editable: true,
    conditions: [
  ...
  },
  {
    ...
    intent:
      "Identify high-risk applications where support and governance become materially more valuable.",
    reason:
      "Operationally critical or regulated apps justify stronger support, consistency, and enterprise controls.",
    enabled: true,
    editable: true,
    conditions: [
      {
