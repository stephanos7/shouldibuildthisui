...
export const baseRules = [
  {
    ...
    intent:
      "Favor direct implementation when the ownership horizon is very short.",
    reason:
      "Prototype work usually does not justify adopting a broader UI platform.",
    enabled: true,
    editable: true,
    conditions: [
  ...
  },
  {
    ...
    intent:
      "Keep a small signal toward lower-overhead choices for short-lived work.",
    reason:
      "Short-term ownership reduces the value of heavier long-term UI investment.",
    enabled: true,
    editable: true,
    conditions: [
      { field: "ownershipHorizon", operator: "equals", value: "short_term" }
    ],
    scores: {
      build_it_yourself: 1
    }
  ...
  },
  {
    ...
    reason:
      "More teams increase the value of shared standards and supported components.",
    enabled: true,
    editable: true,
    conditions: [
  ...
  },
  {
    ...
    reason:
      "A broader app portfolio increases the value of reusable UI foundations.",
    enabled: true,
    editable: true,
    conditions: [
  ...
  },
  {
    ...
    reason:
      "Cross-app consistency increases the value of a reusable component foundation.",
    enabled: true,
    editable: true,
    conditions: [
      {
  ...
  },
  {
    ...
    reason:
      "Org-wide UI standardization increases the value of supported platform choices.",
    enabled: true,
    editable: true,
    conditions: [
      {
  ...
  },
  {
    ...
    reason:
      "A centralized design system benefits from a stronger shared UI foundation.",
    enabled: true,
    editable: true,
    conditions: [
      {
  ...
  },
  {
    ...
    reason:
      "When UI knowledge is concentrated, standardization becomes more valuable.",
    enabled: true,
    editable: true,
    conditions: [
      {
  ...
  },
  {
    ...
    reason:
      "Advanced grids increase the value of richer prebuilt data capabilities.",
    enabled: true,
    editable: true,
    conditions: [
      {
  ...
  },
  {
    ...
    reason:
      "Regulated accessibility raises the value of mature, supported UI infrastructure.",
    enabled: true,
    editable: true,
    conditions: [
      {
  ...
  },
  {
    ...
    reason:
      "Operationally critical applications increase the value of support and standardization.",
    enabled: true,
    editable: true,
    conditions: [
      {
  ...
  },
  {
    ...
    reason:
      "Priority support needs make premium or enterprise packages more attractive.",
    enabled: true,
    editable: true,
    conditions: [
      {
  ...
  },
  {
    ...
    reason:
      "Enterprise support expectations increase the value of enterprise packaging.",
    enabled: true,
    editable: true,
    conditions: [
      {
