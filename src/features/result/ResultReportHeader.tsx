      ...
      >
        <Stack spacing={1.25} sx={{ maxWidth: 760 }}>
          <Stack direction="row" spacing={1} useFlexGap flexWrap="wrap">
            <Chip label={`Policy ${policyVersion}`} size="small" variant="outlined" />
            <Chip label={formatDecisionType(decisionType)} size="small" variant="outlined" />
          </Stack>
          <Typography variant="h4" component="h1">
            Recommendation report
          </Typography>
          <Typography color="text.secondary">
            Your recommended path is based on your answers, the current decision policy, and the
            scoring factors that matched your situation.
          </Typography>
        </Stack>
