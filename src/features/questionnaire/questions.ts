...
export const questions = [
  ...
  },
  {
    ...
    section: "design_system_and_workflow",
    label: "How much friction exists between designers and engineers?",
    component: "radio",
    layout: "two-column",
    options: [
  ...
  },
  {
    ...
    options: [
      { value: "none", label: "No explicit reuse goal" },
      {
        ...
        label: "Consistency within one app or team"
      },
      {
        value: "cross_app_consistency",
        label: "Consistency across multiple apps"
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        value: "some_specialists",
        label: "A few specialists, but coverage exists"
      },
  ...
  },
  {
    ...
    options: [
      ...
      { value: "weeks", label: "Usually 1-2 weeks" },
      { value: "months", label: "Usually more than 2 weeks" }
    ]
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { value: "advanced_grids", label: "Advanced grids with richer behavior" },
      {
        ...
        label: "Mission-critical grid workflows"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { value: "high", label: "High priority" },
      {
        ...
        label: "Regulated or mandatory compliance"
      }
    ]
  },
  {
    ...
    layout: "two-column",
    options: [
      { value: "internal_tool", label: "Internal productivity tool" },
      { value: "customer_facing", label: "Core operational system" },
      { value: "revenue_critical", label: "Revenue-generating product" },
      {
        value: "regulated_or_critical",
        label: "Regulated or critical system"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { value: "high", label: "High urgency" },
      {
        ...
        label: "Fixed deadline with limited flexibility"
      }
    ]
  }
...
function buildSectionDefinition(
  ...
  sectionCount: number
): Omit<QuestionnaireSectionDefinition, "id"> {
  return {
...
function buildQuestionSections() {
  return Array.from(
    { length: Math.ceil(questions.length / questionsPerSection) },
    (_, index) => {
      ...
      return {
        ...
        ...buildSectionDefinition(
          ...
          index + 1,
          Math.ceil(questions.length / questionsPerSection)
        ),
        questionIds: sectionQuestions.map(
          (question) => question.id
        ) satisfies QuestionnaireFieldId[],
